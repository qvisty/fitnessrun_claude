    ...
    <nav class="top-bar expanded" data-topbar role="navigation">
        ...
        <div class="top-bar-section">
            <ul class="right">
                ...
                <li><?= $this->Html->link(__('Race Contestants'), ['controller'=>'race_contestants','action' => 'add']) ?></li>
                <li><?= $this->Html->link(__('Contestants Laps'), ['controller'=>'contestant_laps','action' => 'add']) ?></li>
                <li><?= $this->Html->link(__('Contestans finishtimes'), ['controller'=>'contestant_finishtimes','action' => 'add']) ?></li>
                <li><?= $this->Html->link("|",[]);?></li>
