        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $race->id], ['confirm' => __('Are you sure you want to delete # {0}?', $race->id)." ".__('This will remove all related data like laps and finishtimes')]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
